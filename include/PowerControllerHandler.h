...
public:
     ...
     */
    static std::shared_ptr<PowerControllerHandler> create(std::string endpointId);
    ...
    void setEndpointId(std::string endpointId);
    
private:
    /**
     * Constructor.
     */
    PowerControllerHandler(std::string endpointId);
    
    // Endpoint id to access json file when in smart home handler
