...
public:
    static const std::string MODE_CONTROLLER_MODE_A;

    static const std::string MODE_CONTROLLER_MODE_B;

    static const std::string MODE_CONTROLLER_MODE_C;

    static const std::string MODE_CONTROLLER_MODE_D;
