...
#ifdef MODE_CONTROLLER
static const char MODE_A = '1';
static const char MODE_B = '2';
static const char MODE_C = '3';
static const char MODE_D = '4';
#endif
...
void UserInputManager::endpointControllerMenu() {
    ...
    switch (y) {
        ...
        case static_cast<char>(EndpointControllerMenuChoice::MODE_CONTROLLER_OPTION): {
            ...
            std::cin >> optionSelected;
            if (!std::cin.fail()) {
                if (optionSelected == MODE_A) {
                    m_interactionManager->setMode(ModeControllerHandler::MODE_CONTROLLER_MODE_A);
                } else if (optionSelected == MODE_B) {
                    m_interactionManager->setMode(ModeControllerHandler::MODE_CONTROLLER_MODE_B);
                } else if (optionSelected == MODE_C) {
                    m_interactionManager->setMode(ModeControllerHandler::MODE_CONTROLLER_MODE_C);                
                } else if (optionSelected == MODE_D) {
                    m_interactionManager->setMode(ModeControllerHandler::MODE_CONTROLLER_MODE_D);
                } else if (QUIT == optionSelected) {
                    return;
                } else {
                    m_interactionManager->errorValue();
